...
View the GitHub project [here](https://github.com/NuixSDK/Custom-Exporter) or download the latest release [here](https://github.com/NuixSDK/Custom-Exporter/releases).
...
## Usage
See included [Help]() file for details on how to use this script.
